...
\begin{document}
    ...
    \begin{figure}[h!]
        \centering
        \subfloat{\includegraphics[width = 0.5\textwidth]{../../work/RapidSimAnalysis/NewWeightingFunction/Plots/Dst_PT_All.pdf}}
        \subfloat{\includegraphics[width = 0.5\textwidth]{../../work/RapidSimAnalysis/NewWeightingFunction/Plots/Dst_eta_All.pdf}}
        \hfill
        \subfloat{\includegraphics[width = 0.5\textwidth]{../../work/RapidSimAnalysis/NewWeightingFunction/Plots/Dst_phi_All.pdf}}
    ...
    \begin{figure}[h!]
        \centering
        \subfloat{\includegraphics[width = 0.5\textwidth]{../../work/RapidSimAnalysis/NewWeightingFunction/Plots/sPi_PT_All.pdf}}
        \subfloat{\includegraphics[width = 0.5\textwidth]{../../work/RapidSimAnalysis/NewWeightingFunction/Plots/sPi_eta_All.pdf}}
        \hfill
        \subfloat{\includegraphics[width = 0.5\textwidth]{../../work/RapidSimAnalysis/NewWeightingFunction/Plots/sPi_phi_All.pdf}}
