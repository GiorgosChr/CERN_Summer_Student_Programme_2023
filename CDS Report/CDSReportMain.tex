...
\begin{document}
        ...
        \begin{figure}[h!]
                ...
                \caption{Comparison of $D^0$ kinematics with and without weighting. On the left column we present the new weighting technique and on the right the baseline technique.}
