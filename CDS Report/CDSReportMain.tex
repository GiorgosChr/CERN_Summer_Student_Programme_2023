...
\begin{document}
        ...
        Here, the $D^0$ candidates are reconstructed using the $D^\star$ and $\pi_s$, however, the new weighting function which is much more effective comes from reconstructing $D^0$ candidates from $K^-K^+$ or $\pi^-\pi^+$.
        ...
        As previously discussed, the weighting function allows us to keep events from LHCb with large detection asymmetries in order to have more accurate results.
        ...
        \begin{figure}[h!]
                ...
                \label{fig:detection}
        \end{figure}
        Subsequently, we calculate the weighting function using both methods, once with $D^0$ candidates reconstructed using $D^\star$ and $\pi_s$ and once reconstructed with $K^-K^+$ or $\pi^-\pi^+$.

        We present the distribution of the weighting function values using the two techniques we discussed in Fig.~\ref{fig:weightsBeforeAfter}.
        \begin{figure}[h!]
                \centering
        ...
        \begin{center}
                \begin{tabular}{c|c|c}
                        Reconstruction & Weighted & Unweighted\\
                        \hline\hline
                        $K^-K^+$ & $A_\text{total} = 0.14726 \pm 0.00066$ & \multirow{2}{*}{$A_\text{total} = 0.16268 \pm 0.00064$}\\
                        \cline{1-2}
                        $D^\star\pi_s$ & $A_\text{total} = 0.14994 \pm 0.00066$ & \\
                \end{tabular}
        ...
        The estimated total asymmetry difference is $\Delta A_\text{total} = -0.1$, according to the $CP$ asymmetries we introduced. 
        ...
        \begin{center}
                \begin{tabular}{c|c|c|c}
                        Reconstruction & & Weighted & Unweighted\\
                        \hline\hline
                        \multirow{2}{*}{$K^-K^+$} & $\Delta A_\text{total}$ & $-0.09845 \pm 0.00094$ & $-0.08303 \pm 0.00093$\\
                        & Deviation $(\sigma)$ & $1.65$ & $18.2$\\
                        \hline
                        \multirow{2}{*}{$D^\star\pi_s$} & $\Delta A_\text{total}$ & $-0.09578 \pm 0.00094$ & $-0.08303 \pm 0.00093$\\
        ...
        \begin{center}
                \begin{tabular}{c|c|c}
                        Reconstruction & Weighted & Unweighted\\
                        \hline\hline
                        $K^-K^+$ & $A_\text{total} = - 0.00023 \pm 0.00079$ & \multirow{2}{*}{$A_\text{total} = 0.00002 \pm 0.00079$}\\
                        \cline{1-2}
                        $D^\star\pi_s$ & $A_\text{total} = -0.00002 \pm 0.00079$ & \\
                \end{tabular}
        ...
        \begin{center}
                \begin{tabular}{c|c|c|c}
                        Reconstruction & & Weighted & Unweighted\\
                        \hline\hline
                        \multirow{2}{*}{$K^-K^+$} & $\Delta A_\text{total}$ & $0.00001 \pm 0.00108$ & $0.00026 \pm 0.00108$\\
                        & Deviation $(\sigma)$ & $0.009$ & $0.24$\\
                        \hline
                        \multirow{2}{*}{$D^\star\pi_s$} & $\Delta A_\text{total}$ & $0.00022 \pm 0.00108$ & $0.00026 \pm 0.00108$\\
        ...
        \section{Conclusions}
        As demonstrated the weighting function allows us to keep events with kinematics associated with large detection asymmetries and still perform calculations that are in agreement with the expected values.
